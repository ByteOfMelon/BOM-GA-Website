<template>
	<div class="flex flex-col justify-center items-center space-y-4 sm:p-8 pt-8">
		<div class="flex flex-col items-center space-y-8 text-center w-full">
			<h1 class="text-3xl sm:text-5xl font-extrabold mb-4 grad-title text-shadow-lg">Frequently Asked Questions</h1>
			<div class="card justify-center items-center px-4 sm:px-12 py-4 flex flex-col space-y-4">
                ...
                <div class="flex flex-col w-full justify-center space-y-6" v-else-if="faq">
                    <div class="flex flex-col sm:space-x-8 text-center items-center" v-for="q, index in faq">
                        <h2 class="text-2xl font-bold grad-title sm:mb-0 mb-4">{{ q.title }}</h2>
